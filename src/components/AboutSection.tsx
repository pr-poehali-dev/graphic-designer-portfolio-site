        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-white/55 leading-relaxed mb-6 text-lg">
              Привет! Меня зовут Иван — графический и моушн-дизайнер с более чем 5-летним опытом. Специализируюсь на создании айдентики брендов, motion graphics и анимационного контента.
            </p>
